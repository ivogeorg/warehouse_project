...
1. `ros2 launch cartographer_slam cartographer.launch.py`
2. `ros2 launch map_server map_server.launch.py map_file:=warehouse_map_real.yaml`

**_Note_:** In the second test, the originally created map will be used, not the one that might have been created in first test.
